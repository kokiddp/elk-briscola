...
namespace Briscola.Infrastructure.Sqlite.Migrations.Migrations
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ActiveCardSetId = table.Column<string>(type: "TEXT", maxLength: 64, nullable: false, defaultValue: "placeholder"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SeatScoresJson = table.Column<string>(type: "TEXT", maxLength: 128, nullable: false),
                    TeamScoresJson = table.Column<string>(type: "TEXT", maxLength: 64, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShuffleSeed = table.Column<long>(type: "INTEGER", nullable: false),
                    StateSnapshotJson = table.Column<string>(type: "TEXT", nullable: false),
                    BriscolaSuit = table.Column<string>(type: "TEXT", maxLength: 16, nullable: false),
